...
- **pom.xml:** Contains the Spring Data JPA dependency.
- **Entity classes:** Use annotations such as `@Entity`, `@Table`, and `@Id`.
- **application.properties:** Configures database connection and JPA/Hibernate settings.
...
Swagger is a set of tools that helps developers create, view, and test API documentation.
...
**Spring Boot:** Provides application configuration and setup features.

**Lombok:** Generates getters, setters, and constructors.

**Spring Data JPA:** Provides common database operations through repository interfaces.

**React:** Provides reusable components for creating user interfaces.
...
**Entity Layer:** Represents database data.
